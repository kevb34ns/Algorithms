...
$(OBJS_DIR)/sortTest.o: sorting/sortTest.cpp sorting/selectionSort.cpp sorting/bubbleSort.cpp sorting/insertionSort.cpp sorting/mergeSort.cpp sorting/quickSort.cpp sorting/radixSort.cpp sorting/heapSort.cpp $(OBJS_DIR)/.dirstamp
